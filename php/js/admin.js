...
function createTeamRow(team) {
	...
	var teamAction = $(`<td><button type="button" onclick="if (confirm('Wirklich alle Log-Daten f&uuml;r das Team ${team.name} l&ouml;schen?')) { $.getJSON('ajax.php', { action: 'deleteLog', chipId: '${team.chipId}' }, function(data) { console.log(data); }); }">Reset</button></td>`);
